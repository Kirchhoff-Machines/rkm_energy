...
# Read the CSV file
df = pd.read_csv('../out_csv/cpu_energy_power_analysis.csv')

# Extract data
Nh = df['Nh'].values
time = df['Time (s)'].values
energy = df['Energy (J)'].values
...
plt.tight_layout()
plt.savefig('../out_png/cpu_energy_power_analysis_extrapolation.png')
plt.show()
...
estimated_df.to_csv('../out_csv/cpu_estimated_points.csv', index=False)
print("Estimated points saved to cpu_estimated_points.csv")